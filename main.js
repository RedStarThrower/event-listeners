...
var addItem = function(keyEvent) {
  ...
  if (keyEvent.keyCode === 13) {
      ...
      // var boundFunction = removeGuest.bind(redButton)  <= browser binding act
      // boundFunction()
			//redButton.addEventListener("click", removeGuest)
      var remover = function() {
        guestList.removeChild(newLi)
      }
      redButton.addEventListener("click",remover)
      // var remover2 = function(eventObj) {
      //   var removeButton = eventObj.srcElement
      //   var li = removeButton.parentNode
